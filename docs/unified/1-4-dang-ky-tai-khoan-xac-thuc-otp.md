# Unified Story 1.4: Dang ky tai khoan xac thuc OTP

Status: done

## Phase 1 — Requirements (Original)
> Nguồn: docs/1-2-dang-ky-tai-khoan-khach-hang-xac-thuc-otp.md
...
- [ ] **Backend: OTP Service & Email (AC: 3, 4, 8)**
  ...
  - [ ] Tạo `backend/src/services/email_service.py` với:
    ...
    - Template email với mã OTP, thời gian hết hạn, và branding Nhà May Thanh Lộc
...
- **Subject:** "Xác thực tài khoản Nhà May Thanh Lộc - Mã OTP của bạn"
- **Body:**
  - Greeting: "Xin chào [Họ tên],"
  - Main content: "Mã OTP của bạn là: **[CODE]**"
  - Expiration: "Mã này có hiệu lực trong 10 phút."
  - Footer: Branding Nhà May Thanh Lộc, link hỗ trợ
...
## Traceability
- Phase 1 Story: 1.2 Đăng ký Tài khoản Khách hàng & Xác thực OTP
- Phase 2 Story: 1.4 Đăng ký tài khoản xác thực OTP
- Epic: 1
