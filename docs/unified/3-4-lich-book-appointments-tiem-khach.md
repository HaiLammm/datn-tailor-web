# Unified Story 3.4: Lịch Book Appointments Tiệm & Khách (Calendar UI)
...
> Nguồn: _bmad-output/implementation-artifacts/3-4-lich-book-appointments-tiem-khach.md
...
## Traceability
- Phase 1 Story: N/A
- Phase 2 Story: Story 3.4 Lịch Book Appointments Tiệm & Khách (Calendar UI)  
- Epic: 3
