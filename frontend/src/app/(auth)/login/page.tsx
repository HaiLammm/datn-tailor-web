        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 border border-indigo-100">
            ...
            <form onSubmit={handleCredentialsLogin} className="space-y-4 mb-6">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full px-4 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                >
