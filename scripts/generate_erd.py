#!/usr/bin/env python3
"""
Generate Entity Relationship Diagram (ERD) for Nhà May Thanh Lộc.
...
<title>Nhà May Thanh Lộc &mdash; Database ERD</title>
<style>
  :root {{
...
<body>
<header>
  <h1>Nhà May Thanh Lộc &mdash; Database ERD</h1>
...
<footer>
  Generated by <code>scripts/generate_erd.py</code> &bull; Nhà May Thanh Lộc
</footer>
</body>
</html>
'''
