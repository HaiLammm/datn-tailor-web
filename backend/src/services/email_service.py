...
<head>
    ...
    <title>Xác thực tài khoản Nhà May Thanh Lộc</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                                Cảm ơn bạn đã đăng ký tài khoản tại <strong>Nhà May Thanh Lộc</strong>. 
                    ...
                    <tr>
                        <td style="padding: 30px 40px; background-color: #f9fafb; border-radius: 0 0 8px 8px; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 13px; text-align: center;">
                                © 2026 Nhà May Thanh Lộc - Hệ thống May Đo Thông Minh
                            </p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Khôi phục mật khẩu Nhà May Thanh Lộc</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Georgia', serif; background-color: #f5f5f5;">
    <table role="presentation" style="width: 100%; border-collapse: collapse;">
        <tr>
                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                                Bạn đã yêu cầu khôi phục mật khẩu cho tài khoản tại <strong>Nhà May Thanh Lộc</strong>. 
...
async def send_otp_email(email: str, full_name: str, otp_code: str) -> bool:
    ...
    try:
        ...
        message["Subject"] = f"Xác thực tài khoản Nhà May Thanh Lộc - Mã OTP của bạn"
...
Cảm ơn bạn đã đăng ký tài khoản tại Nhà May Thanh Lộc.
...
---
Nhà May Thanh Lộc - Hệ thống May Đo Thông Minh
© 2026
        """.strip()
...
async def send_reset_password_email(email: str, full_name: str, otp_code: str) -> bool:
    ...
    try:
        # Create message
        message = MIMEMultipart("alternative")
        message["Subject"] = f"Khôi phục mật khẩu Nhà May Thanh Lộc - Mã OTP của bạn"
        message["From"] = settings.FROM_EMAIL
        message["To"] = email
...
Bạn đã yêu cầu khôi phục mật khẩu cho tài khoản tại Nhà May Thanh Lộc.
...
async def send_account_invitation_email(email: str, customer_name: str) -> bool:
    ...
    try:
        # Create message
        message = MIMEMultipart("alternative")
        message["Subject"] = "Lời mời kích hoạt tài khoản Nhà May Thanh Lộc"
        message["From"] = settings.FROM_EMAIL
        message["To"] = email
...
Chúng tôi đã tạo một tài khoản cho bạn tại Nhà May Thanh Lộc.
                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                                Chúng tôi đã tạo một tài khoản cho bạn tại <strong>Nhà May Thanh Lộc</strong>. 
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Nhắc nhở trả đồ - Nhà May Thanh Lộc</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Georgia', serif; background-color: #f5f5f5;">
    <table role="presentation" style="width: 100%; border-collapse: collapse;">
        <tr>
                ...
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 30px 40px; background-color: #F9F7F2; border-radius: 0 0 8px 8px; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 13px; text-align: center;">
                                &copy; 2026 Nhà May Thanh Lộc - Hệ thống May Đo Thông Minh
                            </p>
                            <p style="margin: 0; color: #9ca3af; font-size: 12px; text-align: center;">
                                Email tự động - Vui lòng không trả lời email này
                            </p>
                ...
                <table role="presentation" style="width:600px;border-collapse:collapse;background:#ffffff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="padding:40px 40px 30px 40px;background:linear-gradient(135deg,#1A2B4C 0%,#2d4a7a 100%);border-radius:8px 8px 0 0;">
                            <h1 style="margin:0;color:#D4AF37;font-size:28px;font-weight:600;text-align:center;">Nhà May Thanh Lộc</h1>
    ...
    <body style="margin:0; padding:0; background-color:#F9F7F2; font-family: 'Segoe UI', Arial, sans-serif;">
        <div style="max-width:600px; margin:0 auto; padding:20px;">
            <div style="background-color:#1A2B4C; padding:24px; text-align:center; border-radius:8px 8px 0 0;">
                <h1 style="color:#D4AF37; margin:0; font-size:24px;">Nhà May Thanh Lộc</h1>
            ...
            <div style="background-color:#ffffff; padding:32px; border-radius:0 0 8px 8px;">
                ...
                <p style="color:#6b7280; font-size:12px; margin:24px 0 0; text-align:center;">
                    Nhà May Thanh Lộc - Hệ thống May Đo Thông Minh © 2026
                </p>
            </div>
        </div>
    </body>
...
async def send_order_confirmation_email(order, customer_email: str | None = None) -> bool:
    ...
    try:
        message = MIMEMultipart("alternative")
        message["Subject"] = f"Xác nhận đơn hàng #{str(order.id)[:8].upper()} - Nhà May Thanh Lộc"
        message["From"] = settings.FROM_EMAIL
        message["To"] = email
...
Cảm ơn bạn đã mua sắm tại Nhà May Thanh Lộc!
...
def create_campaign_email_html(body_text: str, shop_name: str = "Nhà May Thanh Lộc") -> str:
